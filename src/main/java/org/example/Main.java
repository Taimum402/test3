    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"repeatedPassword\"]")).sendKeys("Tuhin420");
               ...
               driver.findElement(By.xpath("//*[@id=\"loginPanel\"]/form/div[2]/input")).sendKeys("Tuhin420");
                ...
                driver.findElement(By.xpath("//*[@id=\"billpayForm\"]/form/table/tbody/tr[1]/td[2]/input")).sendKeys("taimum22");
                driver.findElement(By.xpath("//*[@id=\"billpayForm\"]/form/table/tbody/tr[2]/td[2]/input")).sendKeys("38 banglabazar");
